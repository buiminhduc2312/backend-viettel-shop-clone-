...
// Nhật ký tạm thời xác nhận module auth được nạp vào tiến trình backend.
console.log('AUTH ROUTES LOADED', ['/auth/login', '/auth/register', '/auth/forgot-password', '/auth/reset-password']);
